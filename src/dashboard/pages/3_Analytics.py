...
_TIMELINE_COLOR = {"light": "#2a78d6", "dark": "#3987e5"}
_DISTANCE_COLOR = {"light": "#1baf7a", "dark": "#199e70"}
...
_POPULATION_COLORS = {
    "Non-Hazardous": {"light": "#2a78d6", "dark": "#3987e5"},
    "Hazardous": {"light": "#e34948", "dark": "#e66767"},
}

# Reference palette's diverging pair (blue <-> red, neutral gray midpoint),
